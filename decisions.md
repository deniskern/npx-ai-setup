...
| D4 | 2026-04-01 | Architecture | Enforce via hooks, not just rules | Hook > Regel | Was wirklich wichtig ist (TDD, File-Protection, Token-Savings) wird per Hook erzwungen, nicht nur als Markdown-Regel formuliert. Regeln sind Empfehlungen — Hooks sind Garantien. Alle Hooks: Bash-only, <50ms, keine externen Dependencies. | No |
