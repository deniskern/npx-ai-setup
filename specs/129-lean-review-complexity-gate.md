...
- [ ] Step 2: Update `templates/commands/spec-review.md` — remove section 5d (quality scoring), remove score table from section 6 verdict, simplify verdict logic to use code-reviewer + AC pass/fail, add complexity gate for staff-reviewer in section 5c
- [ ] Step 3: Mirror Step 1 changes to `.claude/commands/spec-work.md`
