...
> **Spec ID**: 107 | **Created**: 2026-03-16 | **Status**: completed | **Branch**: —
...
- [x] Step 3: Run smoke tests to verify nothing breaks

## Acceptance Criteria
- [x] SessionStart hook uses `head -20` instead of `cat` for context files
- [x] Smoke tests pass (91/91 or more)
- [x] No other hooks or scripts reference the full SessionStart output
