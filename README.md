...
| **Hooks** | 13 hooks — circuit-breaker, protect-files, post-edit-lint, context-monitor, context-freshness, context-reinforcement, update-check, mcp-health, cli-health, notify, config-change-audit, task-completed-gate, post-tool-failure-log |
